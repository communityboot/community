...
public class AlipayConfig {
    ...
    public static String notify_url = "http://39.106.121:8088/community/aliPay/aliNotify";
    // 页面跳转同步通知页面路径 需http://或者https://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问 商户可以自定义同步跳转地址
    public static String return_url = "http://39.106.121:8088/community/aliPay/aliNotify";
    // 请求网关地址
